void setup() {
  ...
  pinMode(6, INPUT); //Initiates Sesnor Channel A pin
  //Setup Channel B
  pinMode(13, OUTPUT); //Initiates Motor Channel B pin
  pinMode(8, OUTPUT);  //Initiates Brake Channel B pin
  pinMode(7, INPUT); //Initiates Sensor Channel B pin
}

void loop(){
  boolean sensorState1;
  boolean sensorState2;
  sensorState1 = digitalRead(6); //Initiates sensor state
  sensorState2 = digitalRead(7); //The same for the other sensor
